                ...
                <div class="p-6 flex space-x-4 items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            <div>
                                <span class="text-gray-800 font-semibold">{{ $item->user->name }}</span>
                        ...
                        <p class="mt-2 text-lg text-gray-900">{{ __('Title: ') }} {{ $item->title }}</p>
                        <p class="mt-2 text-lg text-gray-900">{{ __('Original Url: ') }}{{ $item->original_url }}</p>
                        <p class="mt-2 text-lg text-gray-900">{{ __('Shortener Url: ') }}
                            <a href="{{ route('shortener-url', $item->shortener_url) }}" target="_blank" class="text-indigo-600 hover:underline">
